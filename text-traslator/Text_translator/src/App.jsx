 ...
 return( 
    ...
    h-screen w-screen flex items-center justify-center">
      ...
      <div className = "flex items-center justify-content-center flex-col gap-y-10 "> 
        <textarea name="input-text" className = "bg-indigo-350 h-30 w-[500px]  border border-indigo-100 ring-2 outline-1 rounded-xl text-xl px-3 py-2 text-black-900"
        onChange={(e) => setTextInput(e.target.value)}/>
        <textarea name="input-text" className = "bg-indigo-350 h-30 w-[500px] font-bold border border-indigo-700 ring-2  outline-1 rounded-xl text-xl px-3 py-2 text-white"
